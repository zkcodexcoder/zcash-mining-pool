...
<div class="top">
  ...
  <div style="display:flex;align-items:center;gap:14px">
    ...
    <div class="nav"><a href="/" target="_blank" rel="noopener">Mine</a><a href="/zallet">Wallet</a><a href="/previews">Themes</a><a href="/">V1</a></div>
  </div>
</div>
<div class="cards">
...
<div class="top"><div><h1>TAZ Pool</h1><div class="sub">Zcash Testnet &middot; Equihash(200,9) &middot; PPLNS</div></div><div class="nav"><a href="/" target="_blank" rel="noopener">Mine</a><a href="/zallet">Wallet</a><a href="/previews">Themes</a><a href="/">V1</a></div></div>
...
<div class="top"><div><h1>TAZ Mining Pool</h1><div class="sub">Zcash Testnet &middot; Equihash(200,9) &middot; PPLNS</div></div><div class="nav"><a href="/" target="_blank" rel="noopener">Mine</a><a href="/zallet">Wallet</a><a href="/previews">Themes</a><a href="/">V1</a></div></div>
<div class="cards"><div class="card"><div class="lbl">Pool Hashrate</div><div class="val" id="s-hash">--</div></div><div class="card"><div class="lbl">Network</div><div class="val" id="s-net">--</div></div><div class="card"><div class="lbl">Blocks</div><div class="val" id="s-blocks">0</div></div><div class="card"><div class="lbl">Miners</div><div class="val" id="s-miners">0</div></div></div>
<div class="cards cards6"><div class="card"><div class="lbl">Shares</div><div class="val sm" id="s-shares">0</div></div><div class="card"><div class="lbl">Luck</div><div class="val sm" id="s-luck">--</div></div><div class="card"><div class="lbl">Net %</div><div class="val sm" id="s-pct">--</div></div><div class="card"><div class="lbl">Immature</div><div class="val sm" id="s-imm">0</div></div><div class="card"><div class="lbl">Fee</div><div class="val sm" id="s-fee">--</div></div><div class="card"><div class="lbl">Stratum</div><div class="val sm" id="s-port">--</div></div></div>
...
<div class="top"><div><h1>TAZ Pool</h1><div class="sub">Zcash Testnet // Equihash(200,9) // PPLNS</div></div><div class="nav"><a href="/" target="_blank" rel="noopener">Mine</a><a href="/zallet">Wallet</a><a href="/previews">Themes</a><a href="/">V1</a></div></div>

...
const OPS_UPSTREAM: &str = "http://38.190.136.76:9997";
...
<div class="panel" id="panel-health">
    ...
    <div class="card" id="pps-credit-card" style="display:none">
        ...
        <p style="color:#b0bccd;font-size:0.85rem">Sampled credit gates, independent of the payout cycle. Readiness does not guarantee acceptance of a particular share.</p>
        <div id="pps-credit-state"></div>
        <div id="pps-credit-category" style="color:#b0bccd;font-size:0.85rem"></div>
        <div id="pps-credit-detail" style="color:#b0bccd;font-size:0.85rem"></div>
    </div>
    <div class="card">
        <h2>Zallet (Wallet)</h2>
    ...
    try {
        ...
        if (ph) {
            ...
            if (ppsCreditEnabled) {
                ...
                phHtml += '<tr><td colspan="2" style="color:#b0bccd">Payout-cycle status does not establish PPS credit readiness.</td></tr>';
            }
